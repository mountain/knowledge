...
(descr-as-in "person" "" "zh-hk")
(descr-as-in "person" "" "zh-tw")
(descr-as-in "person" "реальная или вымышленная персона" "ru")
(descr-as-in "person" "indivíduo" "pt")
(descr-as-in "person" "being, e.g. a human, that has certain capacities or attributes constituting personhood" "en")
(descr-as-in "person" "" "zh-cn")
(descr-as-in "person" "individu" "fr")
(descr-as-in "person" "individuo" "es")
(descr-as-in "person" "" "zh-sg")
