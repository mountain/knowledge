...
(name-as-in "country" "государство" "ru")
(name-as-in "country" "país" "es")
(name-as-in "country" "国" "ja")
(name-as-in "country" "国家" "zh-cn")
(name-as-in "country" "国家" "zh-sg")

(descr-as-in "country" "項目所屬的主權國" "zh-hk")
...
(descr-as-in "country" "この項目について主権を有する国" "ja")
(descr-as-in "country" "项目所属的主权国" "zh-cn")
(descr-as-in "country" "项目所属的主权国" "zh-sg")
