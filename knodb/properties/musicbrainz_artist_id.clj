...
(name-as-in "musicbrainz-artist-id" "" "zh-hk")
(name-as-in "musicbrainz-artist-id" "MusicBrainz音樂家ID" "zh-tw")
...
(name-as-in "musicbrainz-artist-id" "" "zh-cn")
...
(name-as-in "musicbrainz-artist-id" "" "zh-sg")
