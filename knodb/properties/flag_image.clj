...
(name-as-in "flag-image" "旗幟圖片" "zh-hk")
(name-as-in "flag-image" "imagem da bandeira" "pt")
(name-as-in "flag-image" "flag image" "en")
(name-as-in "flag-image" "image du drapeau" "fr")
(name-as-in "flag-image" "旗幟圖像" "zh-tw")
...
(name-as-in "flag-image" "旗帜图像" "zh-cn")
(name-as-in "flag-image" "" "zh-sg")

(descr-as-in "flag-image" "" "zh-hk")
(descr-as-in "flag-image" "imagem da bandeira do item em questão" "pt")
(descr-as-in "flag-image" "image of the item's flag" "en")
(descr-as-in "flag-image" "image de l'emblème de l'élément" "fr")
(descr-as-in "flag-image" "" "zh-tw")
...
(descr-as-in "flag-image" "" "zh-cn")
(descr-as-in "flag-image" "" "zh-sg")
