...
(name-as-in "type-of-administrative-division" "" "zh-hk")
(name-as-in "type-of-administrative-division" "行政區劃類型" "zh-tw")
...
(name-as-in "type-of-administrative-division" "行政区划类型" "zh-cn")
...
(name-as-in "type-of-administrative-division" "" "zh-sg")
...
(descr-as-in "type-of-administrative-division" "" "zh-hk")
(descr-as-in "type-of-administrative-division" "" "zh-tw")
...
(descr-as-in "type-of-administrative-division" "行政区划的类型，如美国州份、意大利市镇" "zh-cn")
...
(descr-as-in "type-of-administrative-division" "" "zh-sg")
