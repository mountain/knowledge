...
(name-as-in "logo-image" "標誌圖片" "zh-hk")
(name-as-in "logo-image" "logotipo" "pt")
(name-as-in "logo-image" "logo image" "en")
(name-as-in "logo-image" "logo" "fr")
(name-as-in "logo-image" "標誌圖像" "zh-tw")
...
(name-as-in "logo-image" "标志图像" "zh-cn")
(name-as-in "logo-image" "标志图像" "zh-sg")

(descr-as-in "logo-image" "企業、組織或產品所使用的標誌" "zh-hk")
...
(descr-as-in "logo-image" "企業、組織或產品所使用的標誌" "zh-tw")
...
(descr-as-in "logo-image" "企业、组织或产品所使用的标志" "zh-cn")
(descr-as-in "logo-image" "企业、组织或产品所使用的标志" "zh-sg")
