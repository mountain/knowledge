...
(name-as-in "logo-image" "標誌圖像" "zh-hk")
...
(descr-as-in "logo-image" "企業、組織或產品所使用的圖形標誌" "zh-hk")
(descr-as-in "logo-image" "企業、組織或產品所使用的圖形標誌" "zh-tw")
...
(descr-as-in "logo-image" "企业、组织或产品所使用的图形标志" "zh-cn")
