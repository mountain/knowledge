...
(name-as-in "date-of-birth" "出生日期" "zh-hk")
...
(name-as-in "date-of-birth" "出生日期" "zh-sg")

(descr-as-in "date-of-birth" "" "zh-hk")
(descr-as-in "date-of-birth" "data na qual o sujeito nasceu" "pt")
...
(descr-as-in "date-of-birth" "その生物が生まれた日付" "ja")
