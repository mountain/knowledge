...
(name-as-in "postal-code" "邮政编码" "zh-cn")
(name-as-in "postal-code" "邮递区号" "zh-sg")

(descr-as-in "postal-code" "" "zh-hk")
(descr-as-in "postal-code" "" "pt")
(descr-as-in "postal-code" "identifier assigned by postal authorities for the subject area or building" "en")
(descr-as-in "postal-code" "code postal/ZIP d'une entité dans le format spécifique d'un pays" "fr")
(descr-as-in "postal-code" "" "zh-tw")
(descr-as-in "postal-code" "Postleitzahl einer Adresse in jeweils landesspezifischem Format" "de")
(descr-as-in "postal-code" "идентификатор, присвоенный данному элементу местной почтовой службой" "ru")
(descr-as-in "postal-code" "código identificador asignado por una autoridad postal para un área determinada" "es")
(descr-as-in "postal-code" "この項目の郵便番号（地域毎に形式が異なる）" "ja")
(descr-as-in "postal-code" "" "zh-cn")
(descr-as-in "postal-code" "" "zh-sg")
