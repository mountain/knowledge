...
(name-as-in "top-level-domain" "" "zh-hk")
(name-as-in "top-level-domain" "頂級域名" "zh-tw")
...
(descr-as-in "top-level-domain" "" "zh-hk")
(descr-as-in "top-level-domain" "" "zh-tw")
...
(descr-as-in "top-level-domain" "" "zh-cn")
...
(descr-as-in "top-level-domain" "" "zh-sg")
