...
(name-as-in "commons-category" "" "zh-hk")
(name-as-in "commons-category" "維基資源共享分類" "zh-tw")
...
(descr-as-in "commons-category" "" "zh-hk")
...
(descr-as-in "commons-category" "与此项目有关的维基共享资源分类 (略去 Category: 字首)" "zh-cn")
