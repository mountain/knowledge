...
(descr-as-in "birth-name" "" "zh-hk")
(descr-as-in "birth-name" "" "zh-tw")
(descr-as-in "birth-name" "если отличается от текущего" "ru")
(descr-as-in "birth-name" "nome de nascença, se for diferente" "pt")
(descr-as-in "birth-name" "name at birth, only if different from current name" "en")
(descr-as-in "birth-name" "" "zh-cn")
