...
(name-as-in "place-of-burial" "" "zh-hk")
(name-as-in "place-of-burial" "" "zh-tw")
...
(descr-as-in "place-of-burial" "" "zh-hk")
(descr-as-in "place-of-burial" "" "zh-tw")
...
(descr-as-in "place-of-burial" "一个人的坟墓、埋葬地、骨灰撒放地点，等 (例：城市或坟场)。" "zh-cn")
...
(descr-as-in "place-of-burial" "" "zh-sg")
